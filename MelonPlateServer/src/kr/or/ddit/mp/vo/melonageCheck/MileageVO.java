package kr.or.ddit.mp.vo.melonageCheck;
...
public class MileageVO implements Serializable {
	...
	public MileageVO(String mel_no, String mem_no, String order_no, String melonage, String mel_use, String mel_add,
			String mel_update, String mel_indate, String mel_status, String eat_name, String order_price) {
		super();
		this.mel_no = mel_no;
		this.mem_no = mem_no;
	...
	public String getMel_status() {
		return mel_status;
	}

	public void setMel_status(String mel_status) {
		this.mel_status = mel_status;
	}
