...
public class T06_ListSortTest {
	...
	- 보통 객체 자체에 정렬기능을 넣기 위해서는 Comparable을 구현하고 정렬 기준을 별도로 구현하고 싶을 때는 Comparator를
	구현하여 사용하면 된다.
	- Comparable에서는 compareTo()메서드를 구현해야하고, Comparator에서는 compare()메서드를 구현해야한다.
	*/
...
class Desc implements Comparator<String>{
	...
	이 메서드의 반환값은 오름차순에 맞게 반환되로독 구현되어 있다.
