...
public class T10_TreeSetTest {
	public static void main(String[] args) {
		...
		//TreeSet에 저장된 자료 중 특정한 자료보다 작은 자료를 찾아서 SortedSet으로 -> headSet(기준 값)메서드 (기본적으로 '기준값'은 포함
		//시키지 않는다.)
		//-> headSet(기준값)메서드(기본적으로'기준값'은 포함시키지 않는다.)
		//-> headSet(기준값,논리값)(논리값이 true이면 기준값을 포함시킨다.)
		SortedSet<String> ss1 = ts.headSet("K");
		System.out.println("K 이전 자료  : " + ss1); // 기준값 미포함
		System.out.println("K 이전 자료 (기준값 포함) : " + ts.headSet("K",true)); // 기준값 미포함
		...
		//                        (기준값1 포함, 기준값2 미포함)
		//subSet(기준값1, 논리값2, 기준값2, 논리값2) => 각 기준값을 포함할지 여부 설정함
