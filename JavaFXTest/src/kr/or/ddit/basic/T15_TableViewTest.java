   ...
   public void start(Stage primaryStage) throws Exception {
      ...
      ObservableList<Member> data = 
            FXCollections.observableArrayList(
                  new Member("이재호", "jaeho",22, "2222-2222", "인천"),
                  new Member("심윤희", "younhee",33, "3333-2222", "대전3"),
                  new Member("전영현", "0hun",44, "4444-2222", "부여"),
                  new Member("이종우", "jongu",55, "5555-2222", "대전")
                  );
      ...
      //해당 컬럼에 나타낼 데이터 연결하기
      korNameCol.setCellValueFactory( // 실제 데이터 값을 만들어주는 메소드
      ...
      TableColumn<Member, Integer> telCol = 
            new TableColumn<>("전화번호");
      telCol.setCellValueFactory(new PropertyValueFactory<>("tel"));
      
      TableColumn<Member, Integer> addrCol = 
            new TableColumn<>("주소");
      ...
      btnEdit.setOnAction(e->{
         ...
         data.set(table.getSelectionModel().getSelectedIndex(), // 인덱스번호 찾기  
               new Member(txtKorName.getText(), // 수정할 데이터
               txtEngName.getText(),
               Integer.parseInt(txtAge.getText()),
               txtTel.getText(),
               txtAddr.getText()));
      ...
      btnTest1.setOnAction(e->{
         // TextField, TextArea 등 문자를 입력하는 객체를 ReadOnly를 설정하는 메서드 -> setEditable()
