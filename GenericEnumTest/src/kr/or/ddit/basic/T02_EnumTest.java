...
public class T02_EnumTest {
	...
	public static void main(String[] args) {
		 ...
		 *  3.valueOf("열거형 상수이름") => 지정된 열거형에서 '열거형사수이름'과 일치하는
		 *  						   열거형 상수를 반환한다.
		 */
		...
		//열거형 객체변수에 값 저장하기
		myCity1 = City.서울;
		myCity2 = City.valueOf("서울"); //City enuim에서 '서울'인 객체 반환
		
		System.out.println("myCity1 : " + myCity1.name());
		System.out.println("meyCity1의 ordinal : " + myCity1.ordinal());
		
		System.out.println("myCity2 : " + myCity2.name());
		System.out.println("meyCity2의 ordinal : " + myCity2.ordinal());
		System.out.println("=========================================");
